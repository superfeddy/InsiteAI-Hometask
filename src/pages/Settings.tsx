  ...
  return (
    <div className="flex justify-center">
      <div className="container pt-20 px-10 flex flex-col gap-10">
        ...
        <Collapse>
          <CollapseItem title="Privacy Policy">
            Thanks for entrusting GitHub, Inc. or GitHub B.V. (“GitHub”, “we”,
            "us" or "our") with your source code, your projects, and your
            personal data. This Privacy Statement explains our practices
            regarding the collection, use, and disclosure of your data,
            including any personal data we collect and process in connection
            with our website and any applications, software, products, and
            services provided by GitHub, including any Beta Previews
            (collectively, the “Service(s)”).
          </CollapseItem>
          <CollapseItem title="Terms of Service">
            <p className="font-semibold text-xl pt-4 pb-2">
            ...
            <p>
              ...
              any harm resulting from, any User-Generated Content that you post,
              upload, link to or otherwise make available via the Service,
              regardless of the form of that Content. We are not responsible for
            ...
            <p>
              ...
              that, in our sole discretion, violates any laws or GitHub terms or
              policies. User-Generated Content displayed on GitHub Mobile may be
              subject to mobile app stores' additional terms.
            </p>
            <p className="font-semibold text-xl pt-4 pb-2">
              3. Ownership of Content, Right to Post, and License Grants
            </p>
            <p>
              You retain ownership of and responsibility for Your Content. If
            ...
            <p>
              ...
              Content, we need you to grant us — and other GitHub Users —
              ...
              already comes with a license granting GitHub the permissions we
            ...
            <p>
              ...
              It also does not grant GitHub the right to otherwise distribute or
              use Your Content outside of our provision of the Service, except
              that as part of the right to archive Your Content, GitHub may
              permit our partners to store and archive Your Content in public
              repositories in connection with the GitHub Arctic Code Vault and
            ...
            <p>
              If you set your pages and repositories to be viewed publicly, you
              grant each User of GitHub a nonexclusive, worldwide license to
              use, display, and perform Your Content through the GitHub Service
              and to reproduce Your Content solely on GitHub as permitted
              through GitHub's functionality (for example, through forking). You
            ...
            <p className="font-semibold text-xl pt-4 pb-2">7. Moral Rights</p>
            <p>
            ...
            <p>
              ...
              you grant GitHub the rights we need to use Your Content without
